...
void Printtest(int Code){  // int Code: 1 for HUMAN, 0 for AI(COMPUTER)
    ...
    mvprintw(scrLine / 2 + 17, scrCol/ 4 + 30,"[I] View the Item Manual");
...
int Human(){
    ...
    if(userInput=='d' || userInput=='D'){ //ShootAI
        ...
        mvwprintw(new_win, 3, 1, "Key Item Name      Description");
        mvwprintw(new_win, 5, 1, "[1] Sharp Eye      You have a sharp eye to see if next bullet is");
        mvwprintw(new_win, 6, 1, "                   real or fake.");
        mvwprintw(new_win, 8, 1, "[2] Double Damage  After using the Double Damage Item, your next");
        mvwprintw(new_win, 9, 1, "                   bullet will deal 2 damage if it is real.");
        mvwprintw(new_win, 11, 1,"[3] Ban            After using the Ban Item, your opponent will ");
        ...
        mvwprintw(new_win, 15, 1,"[4] Recharge       After using the Recharge Item, your energy will");
